...
<table align="center" cellpadding="0" cellspacing="0" height="100%" width="100%">
    ...
    background: linear-gradient(-135deg, #c850c0, #4158d0);" width="100%">
                                ...
                                <tr class="">
                                    <td class="headline">Bienvenue à toi <?php echo $pseudo?>, sur Li Logement</td>
                                </tr>
                                <tr>
                                    <td>
                                        <center class="">
                                            <table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;"
                                                ...
                                                <tr class="">
                                                    <td class="" style="color:#A0D8F4;"><br>
                                                        ...
                                                        <br>
                                                        <br>
                                                        <img alt="robot picture" class="" height="175"
                                                             src="https://cdn.discordapp.com/attachments/912646044934864926/913010553633534002/logo-PHP.png"
                                                             width="175">
                                                        <br>
                                                        <br></td>
                                                </tr>
                                    ...
                                    <td class="">
                                        <div class=""><!--[if mso]>
                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                ...
                                                <center>
                                            <![endif]-->
                                            <a class="" data-click-track-id="6155" href="<?php echo base_url('/login')?>"
                                            style="background-color:#73BD4D;border-radius:15px;color:#ffffff;display:inline-block;font-family:Helvetica,
                                            Arial,
                                            sans-serif;font-size:18px;font-weight:normal;line-height:50px;text-align:center;text-decoration:none;width:350px;-webkit-text-size-adjust:none;"><b>Je
                                                me Connecte</b></a>
                                            <!--[if mso]>
                                            </center>
                                            </v:roundrect>
